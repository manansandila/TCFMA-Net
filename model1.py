...
from glob import glob
def TCFMA(input_size=(256,256,3),input_size_2=(256,256,1)):
    n_labels=1
    feature_scale=8
    ...
    #############################################
    n12,n22 = CFE(n11,n21,32,64,16)
    pred2 = Conv2D(1,(1,1), strides=(1,1), padding="same",activation='sigmoid')(n12)
    n32,n42 = CFE(n31,n41,128,256,64)
    n12,n22 = CFE(n12,n22,32,64,16)
    pred3 = Conv2D(1,(1,1), strides=(1,1), padding="same",activation='sigmoid')(n12)
    n32,n42 = CFE(n32,n42,128,256,64)
    n22,n32 = CFE(n22,n32,64,128,32)
    n13,n23 = CFE(n12,n22,32,64,16)
    n33,n43 = CFE(n32,n42,128,256,64)
    n23,n33 = CFE(n23,n33,64,128,32)
    n13,n23 = CFE(n12,n22,32,64,16)
    n33,n43 = CFE(n32,n42,128,256,64)
...
def CFE(x,y,nf1=128,nf2=1212,gc=64,bias=True):
...
def MAM(input_features,gating_features,in_channels,out_channels,kernel_size=1,stride=1,dilation=1,groups=1):
